 ...
 * Description:       AI-powered form builder for WordPress. Generate forms with natural language, render via shortcodes, and bring your own AI key or use our managed service.
 * Version:           0.1.0
